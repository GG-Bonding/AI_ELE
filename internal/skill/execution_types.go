...
type DurableExecutionStore interface {
	...
	// CreateStepFenced inserts a step only when the execution lease_epoch matches.
	CreateStepFenced(ctx context.Context, st StepExecution, expectedEpoch int64) (StepExecution, bool, error)
